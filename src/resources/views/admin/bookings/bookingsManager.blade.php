        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body p-2">
                    ...
                    @if(count($bookings) < 1) <div class="alert alert-warning wizard">
                ...
                <table class="table table-light">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center align-middle">{{$booking->desk_id}}</td>
                            <td class="text-center align-middle">{{$booking->name}}</td>
                            <td>
                                <a role="button" class="btn btn-danger float-end" data-bs-toggle="modal" data-bs-target="#deleteModal{{$booking->id}}"><i class="bi bi-trash3-fill"></i></a>
                                <a href="{{route('editBooking',$booking->id)}}" class="btn btn-secondary float-end mx-1"><i class="bi bi-pencil-square"></i></a>
                                <a href="{{route('viewBooking',$booking->id)}}" class="btn btn-info float-end"><i class="bi bi-eye-fill text-white"></i></a>
                            </td>
                        </tr>
