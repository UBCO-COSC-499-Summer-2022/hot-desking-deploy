                    ...
                    <form method="POST" action="{{route('floorStore')}}">
                        ...
                        <fieldset>
                            <div class="mb-3">
                                ...
                                <input type="text" name="floor_num" id="floor_num" class="form-control @error('floor_num') is-invalid @enderror" placeholder="Floor Number" maxlength="10" minlength="1" required>
                                @error('floor_num')
