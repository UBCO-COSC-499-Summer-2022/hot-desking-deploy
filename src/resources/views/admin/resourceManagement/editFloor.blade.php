                    ...
                    <form method="POST" action="{{route('floorUpdate', $floor->id)}}">
                        ...
                        <fieldset>
                            <div class="mb-3">
                                ...
                                <input type="text" name="floor_num" id="floor_num" class="form-control @error('floor_num') is-invalid @enderror" maxlength="10" minlength="1" value="{{$floor->floor_num}}" required>
                                @error('floor_num')
